...
# Simple script for installing Zabbix 5.4 
...
# Using MariaDB 10.7 so in the future you need to upgrade your Zabbix, you won't need to upgrade database as well
# Let's add MariaDB repository


cat << EOF >> /etc/yum.repos.d/MariaDB.repo
# MariaDB 10.7 CentOS repository list - created 2022-03-04 15:05 UTC
# https://mariadb.org/download/
[mariadb]
name = MariaDB
baseurl = https://ftp.osuosl.org/pub/mariadb/yum/10.7/centos8-amd64
module_hotfixes=1
gpgkey=https://ftp.osuosl.org/pub/mariadb/yum/RPM-GPG-KEY-MariaDB
gpgcheck=1
EOF

# Let's install MariaDB 10.7
